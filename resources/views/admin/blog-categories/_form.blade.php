@php $categoryModel = $blogCategory ?? null; @endphp
...
<div class="mb-3">
    ...
    <textarea class="form-control" id="description" name="description" rows="3">{{ old('description', $categoryModel->description ?? '') }}</textarea>
</div>
